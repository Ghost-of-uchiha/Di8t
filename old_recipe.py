...
COMMON_INGREDIENTS = [
    ...
    "Tomatoes", "Onions", "Garlic", "Spinach", "Kale", 
    "Broccoli", "Carrots", "Bell Peppers", "Mushrooms", 
    "Milk", "Yogurt", "Cheese", "Beans", "Lentils", "Nuts",
    "Olive Oil", "Salt", "Pepper", "Ginger", "Cumin", "Cinnamon",
